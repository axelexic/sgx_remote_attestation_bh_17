...
\section{Introduction}
  ...
  \begin{description}
    ...
    \item[Provisioning Seal Key]: This key is derived joinly from Root
      ...
      (see \cite{intelsdm} \S39.1.4 for details) and any enclave
  ...
  a 128-bit number called \textit{Key Wearout Protection}. In addition,
  certain keys can be further diversified using \mrenclave\ or \mrsigner\
  of the enclave.
