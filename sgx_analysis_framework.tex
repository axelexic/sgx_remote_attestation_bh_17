...
\section{Introduction}
  ...
  injected into CPU, and finally destroyed. Unless these keys are
  generated via oracle access (and Intel can provide a proof to 
  that effect), one should consider the Root Seal Key to be 
  known to Intel.
  ...
  keys that are derived from these two base key (see Figure~\ref{fig:keys}):
